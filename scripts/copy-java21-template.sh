...
TEMPLATE_DIR="${DEVKIT_DIR}/templates/java21"
...
cp "${TEMPLATE_DIR}/docs/java21-best-practices.md" "${TARGET_PROJECT}/docs/java21-best-practices.md"

echo "Java 21 template copied to: ${TARGET_PROJECT}"